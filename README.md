...
| `/goal-cleanup --list` | List orphaned goals from sessions where `/clear` was used. (Phase 6.4 — coming in v0.1) |
| `/goal-cleanup --delete --older-than N` | Delete orphaned goals older than N days. (Phase 6.4 — coming in v0.1) |
