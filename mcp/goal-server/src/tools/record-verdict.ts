import type { GoalsRepo, EvaluatorVerdict } from "../goals-repo.js";

const VERDICTS: EvaluatorVerdict[] = ["complete", "incomplete", "unverifiable", "impossible"];
const REASON_MAX = 1000;
const EVIDENCE_MAX_ITEMS = 20;
const EVIDENCE_ITEM_MAX = 500;

export function handleRecordVerdict(
  repo: GoalsRepo,
  args: {
    session_id: string;
    goal_id?: string | null;
